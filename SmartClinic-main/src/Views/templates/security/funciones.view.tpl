...
<div class="crud-header">
  <h2>Funciones</h2>
  <a href="index.php?page=Security_Funcion&mode=INS" class="btn-nuevo">+ Nueva Función</a>
</div>

<form class="filtros" action="index.php" method="get">
  <input type="hidden" name="page" value="Security_Funciones">
  <div class="filtro-group">
    <label for="partialName">Código o Descripción</label>
  ...
  <table>
    ...
    <tbody>
      ...
      <tr>
        <td>{{fncod}}</td>
        <td>{{fndsc}}</td>
        <td><span class="badge-status" data-status="{{fnest}}">{{fnest}}</span></td>
