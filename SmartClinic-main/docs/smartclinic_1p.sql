...
-- Venta de medicamentos desde la receta del doctor: cuando el paciente
-- decide comprar un medicamento recetado con la clínica (en vez de en otra
-- farmacia), se genera esta factura y se descuenta el inventario del
-- centro donde ocurrió la consulta. Mismo patrón que factura_compra/
-- factura_compra_detalle, pero en sentido contrario (aquí se resta stock).
