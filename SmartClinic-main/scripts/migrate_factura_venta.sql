-- Tablas para ventas de medicamentos originadas en una receta médica.
...
CREATE TABLE IF NOT EXISTS factura_venta (
    ...
    FOREIGN KEY (centro_salud_id) REFERENCES centro_salud (id)
        ON DELETE RESTRICT ON UPDATE CASCADE,
    FOREIGN KEY (usuario_id) REFERENCES usuario (usercod)
